package algorithm.sensitiveword;
...
public class SensitiveWordUtil {
    ...
    public static void main(String[] args) {
        ...
        String string = "太多了的伤感情怀也许只局限于饲养基地 荧幕中的情节。"
        ...
        System.out.println("过滤消耗时间"+ (System.currentTimeMillis() - star)+" ms");
        System.out.println(filterStr);
